...
from data.synthetic.molecular_dataset import (
    SyntheticMolecularDataset,
    create_dataloader,
)


cfg_path = Path("/home/loqman/Downloads/projs/physics_aware_diffusion/configs/fp_energy_with_trainable_gate.yaml")
...
vs = LinearVS(
    beta_start=vs_cfg["beta_start"],
    beta_end=vs_cfg["beta_end"],
    min_variance=vs_cfg["min_variance"],
)
fwd = ForwardVP(vs)
