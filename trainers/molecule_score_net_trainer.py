            ...
            for step, batch in enumerate(pbar):
                ...
                if self.use_amp:
                    with torch.amp.autocast('cuda'):
                        noisy_x = self.forward_vp(x, noise, time_per_atom)
                        ...
                        loss = self.loss_fn(pred_noise=score, target_noise=noise, variance=variance, batch_idx=batch_idx) / self.grad_acc
